...
describe('Token based voting', () => {
  ...
  it('Should vote full, then 50%', async () => {
    ...
    await helper.assertProposalMemberWeights(helper.guardian, 10);
    ...
    await helper.assertProposalMemberWeights(helper.guardian, 5);
  });
  ...
  it('Should vote twice without spending', async () => {
    ...
    await helper.assertProposalMemberWeights(helper.guardian, 15);
  });
});
