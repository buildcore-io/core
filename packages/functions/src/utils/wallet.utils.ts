...
const validateWithSignature = async (req: WenRequest<unknown>) => {
...
const validateLegacyPubKey = async (req: WenRequest<unknown>) => {
...
const validateSmrPubKey = async (req: WenRequest<unknown>) => {
...
const validateIotaPubKey = async (req: WenRequest<unknown>) => {
...
const validateWithPublicKey = async (req: WenRequest<unknown>) => {
...
const validatePubKey = async (info: INodeInfo, req: WenRequest<unknown>) => {
...
const validateWithIdToken = async (req: WenRequest<unknown>, func: WEN_FUNC) => {
...
export const getProject = (req: WenRequest<unknown>, requireProjectApiKey = true) => {
  try {
