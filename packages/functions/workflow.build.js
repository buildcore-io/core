...
function job(outputFile, chunk, files, commandName) {
  ...
  fs.appendFileSync(outputFile, `          npx lerna bootstrap --scope=@soonaverse/interfaces\n`);
  fs.appendFileSync(outputFile, `          npx lerna bootstrap --scope=@soonaverse/functions\n`);
