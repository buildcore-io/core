...
import connectToggleRefinement, {
  ToggleRefinementConnectorParams, ToggleRefinementWidgetDescription
...
export class AlgoliaToggleComponent extends TypedBaseWidget<ToggleRefinementWidgetDescription, ToggleRefinementConnectorParams> implements OnInit {
  @Input() label = '';
  @Input()
