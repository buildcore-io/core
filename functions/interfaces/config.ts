...
export const DEFAULT_TRANSACTION_DELAY = 120 * 1000;
...
export const BADGE_TO_CREATE_COLLECTION: string[] = ['0x6baa35ee540ce700978226aaab2b1d97d8fb54ba', '0x3ccb9fe9d6f429981522fb1927a2259149a4a192'];
