...
import { Collection, CollectionStatus, UnsoldMintingOptions } from "../../interfaces/models"
...
describe('Minted nft trading', () => {
  ...
  it('Should throw can not be set for sale during minting', async () => {
    ...
    await requestFundsFromFaucet(helper.network!, collectionMintOrder.payload.targetAddress, collectionMintOrder.payload.amount)
