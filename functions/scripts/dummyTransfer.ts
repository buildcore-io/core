...
import {
  ...
  Ed25519Address,
  Ed25519Seed,
  ED25519_ADDRESS_TYPE, IKeyPair, ISigLockedSingleOutput, IUTXOInput, sendAdvanced, SIG_LOCKED_SINGLE_OUTPUT_TYPE, SingleNodeClient, UTXO_INPUT_TYPE
} from "@iota/iota.js";
...
async function run() {
    ...
    const mnemonic = 'bitter icon bridge age uncle drop radar cook wrap soda purse claim scrub toast day shop marble rural target island asset ethics seven picture'; // "giant dynamic museum toddler six deny defense ostrich bomb access mercy blood explain muscle shoot shallow glad autumn apple calm heavy hawk apple rally"; // atoi1qpg4tqh7vj9s7y9zk2smj8t4qgvse9um42l7apdkhw6syp5ju4w3vet6gtj
    ...
    const decodeBench32Target = Bech32Helper.fromBech32('atoi1qpg4tqh7vj9s7y9zk2smj8t4qgvse9um42l7apdkhw6syp5ju4w3vet6gtj', nodeInfo.bech32HRP);
    ...
    const { messageId } = await sendAdvanced(client, inputsWithKeyPairs, outputs, {
        ...
        data: Converter.utf8ToBytes(JSON.stringify({
