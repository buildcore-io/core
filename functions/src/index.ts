...
import { hidePlaceholderAfterSoldOut, ipfsForNft, markAwardsAsComplete, reAttachWallet, voidExpiredOrders } from "./cron";
...
// CRON Tasks
exports['cron_reAttachWallet'] = reAttachWallet;
