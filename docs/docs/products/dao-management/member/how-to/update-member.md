...
`update` takes an object of type `Build5Request<`[`MemberUpdateRequest`](../../../../reference-api/interfaces/interfaces_src_search_post.MemberUpdateRequest.md)`>` as parameter.
