...
`createProject` takes an object of type [`BuildcoreRequest`](../../reference-api/interfaces/BuildcoreRequest)`<`[`ProjectCreateRequest`](../../reference-api/interfaces/ProjectCreateRequest.md)`>` as parameter.
